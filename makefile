...
mpiexec -np 1 ./$fileName -iga_view -ts_monitor -snes_monitor -ksp_type preonly -pc_type lu -pc_factor_mat_solver_package mumps -ts_max_snes_failures 200 -iga_geometry mesh.dat -iga_periodic 0,1
#-ksp_monitor
