...
mpiexec -np 4 ./$fileName -iga_view -ts_monitor -snes_monitor -ksp_type preonly -pc_type lu -pc_factor_mat_solver_package mumps -ts_adapt_type none -snes_type newtontr -ts_max_snes_failures 500 -snes_max_it 100 -snes_max_funcs 50000 -iga_geometry mesh.dat -iga_periodic 0,1
#-ksp_monitor
