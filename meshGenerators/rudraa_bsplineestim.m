...
knots=t;
controlPoints=D;
save('cap160.mat','order','knots','controlPoints','-v6') %version 6 format needed to read into python using scipy.io.loadmat
