...
PetscErrorCode setBCs(BVPStruct& bvp, PetscInt it_number, PetscReal c_time)
{
  ...
  case 3: //pullout BVP
    ...
    bvp.tractionOnTop=c_time*2.2; // (tension=0.1, traction=28 with 300 steps works), (0.2, 40 with 300 steps works)
#ifndef  enableForceControl
    ...
    //Neumann
    bvp.angleConstraints[0]=true; 
    bvp.angleConstraints[1]=false; 
    bvp.epsilon=bvp.kMean*1.0;
    break;
  }
  //
...
int main(int argc, char *argv[]) {
  ...
  bvp.l=20.0;              //20nm
  bvp.kMean=20; //320.0;         //320pN-nm, mean curvature modulus
